...
exports.run = (client, message, args) => {
  ...
  if (!modlog) return message.reply('`ceza-takip-listesi` kanalini bulamiyorum.');
  ...
  const embed = new Discord.RichEmbed()
    ...
    .addField('Kullanici:', `${user.username}#${user.discriminator} (${user.id})`)
...
exports.help = {
  name: 'unban',
  description: 'İstediğiniz kisinin banini kaldirir.',
  usage: 'unban [kullanici] [sebep]'
};
